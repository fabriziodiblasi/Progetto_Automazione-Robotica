function [trajectory_p,trajectory_v,trajectory_a] = compute_trajectory( q_start, q_stop, step_time, NPunti)
    ...
    trajectory_a = clean_and_resample(step_time, q_traj_t, q_traj_a);
